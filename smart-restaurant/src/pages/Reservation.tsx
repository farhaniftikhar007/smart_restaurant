                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors appearance-none ${
                  ...
                  <div className="flex justify-end">
                    <motion.button
                      ...
                      className={`px-8 py-4 bg-orange-500 text-white rounded-lg transition-colors ${
                        (isSubmitting || !isFormValid) ? 'opacity-50 cursor-not-allowed' : 'hover:bg-orange-600'
                      }`}
                    >
